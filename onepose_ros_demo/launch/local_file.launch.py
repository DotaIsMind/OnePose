...
_TMP_MARK = Path("/home/data/qrb_ros_simulation_ws/OnePose-main/data/demo") / _OBJ_NAME
...
_VIS_DIR = str( "/home/data/qrb_ros_simulation_ws/OnePose-main/onepose_ros_demo/pose_estimation_outputs_" + _OBJ_NAME.name)

...
可选 ONNX（推荐无 GPU 且不想装 PyTorch CUDA）::
    ...
    python run_single.py --data-dir "../../data/demo/mark_cup mark_cup-annotate" \ 
        --outputs-dir "../../data/demo/mark_cup/sfm_model" \ 
...
def _extract_features_onnx(img_lists: list, feature_out: str, cfg):
    ...
    # )
    sp_onnx = cfg.network.detection_model_path
...
def _match_features_onnx(cfg, feature_path: str, covis_pairs: str, matches_out: str):
    ...
    # )
    sg_onnx = cfg.network.matching_model_path

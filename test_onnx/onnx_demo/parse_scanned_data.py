...
# ---------------------------------------------------------------------------
# Monkey-patch NumPy 2.0 incompatibilities in the system-installed transforms3d
# library before it is imported.
#   - np.float      was removed in NumPy 1.24
#   - np.maximum_sctype was removed in NumPy 2.0
# ---------------------------------------------------------------------------
...
if __name__ == "__main__":
    # test: python parse_scanned_data.py --scanned_object_path /home/data/qrb_ros_simulation_ws/OnePose-main/data/demo/mark_cup
    args = parse_args()
